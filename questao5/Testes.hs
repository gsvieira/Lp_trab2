...
-------------------------------------- testes da questao 2
prog3 = Prog (SBlock [SAss (Ident "w") (EStr "hello"),
...
prog4 = Prog (SBlock [SAss (Ident "a") ETrue,
                      SAss (Ident "b") EFalse, 
                      SAss (Ident "e") ETrue, 
...
testCase4= executeP [] prog4 == Right [("a",ValorBool True),("b",ValorBool False),("e",ValorBool True),
...
testSuite = foldl (&&) True [testCase1,testCase2,testCase3,testCase4,testCase5,
